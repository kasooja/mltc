...
import org.insightcentre.classifiers.dl4j.text.classification.data.iterator.WVPOS_DataIterator;
...
public class DataProducer {
	...
	public DataProducer(int noOfFolds, String dataPath, WordVectors wordVectors, int trainBatchSize,
	...
	public static void main(String[] args) {
		...
		DataProducer dataProducer = new DataProducer(10, DATA_PATH, wordVectors, 
				trainBatchSize, testBatchSize, truncateReviewsToLength, WVPOS_DataIterator.class);
