	...
	public static void main(String[] args) throws Exception {
		...
		MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
				...
				.layer(0, new ConvolutionLayer.Builder(5, 5)
                        ...
                        .activation("relu")
                        .build())
				.layer(1, new GravesLSTM.Builder().nIn(vectorSize).nOut(25)
		...
		DataProducer cfiterator = new DataProducer(noOfFolds, DATA_PATH, wordVectors, trainBatchSize, testBatchSize, truncateReviewsToLength, WVPOS_DataIterator.class);
