 ...
 * @author K
 */
public class WV_DataIterator implements DataSetIterator {
	...
	public WV_DataIterator(WordVectors wordVectors, List<String> positiveFiles, List<String> negativeFiles, int batchSize, int truncateLength){
	...
	public static void main(String[] args) {
		...
		Constructor<?>[] constructors = WV_DataIterator.class.getConstructors();
