 ...
 * @author K
 */
public class WVPOS_DataIterator implements DataSetIterator {
	...
	public WVPOS_DataIterator(WordVectors wordVectors, List<String> positiveFiles, List<String> negativeFiles, int batchSize, int truncateLength){
		...
		for(String s : reviews){
			...
			for(TaggedWord t : tokens){
				if(wordVectors.hasWord(t.word().toLowerCase())) {
					tokensFiltered.add(t.word().toLowerCase().trim()+ "specialCharSpecialchar" + t.tag());
				}
			}
	...
	public static void main(String[] args) {
		...
		Constructor<?>[] constructors = WVPOS_DataIterator.class.getConstructors();
